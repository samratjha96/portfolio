...
`,lr=()=>{const[e,t]=y.useState(""),[n,r]=y.useState(!1),[a,i]=y.useState(!1);return y.useEffect(()=>{const s=()=>{window.scrollY>100?i(!0):i(!1)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]),o("nav",{className:`${C.paddingX} w-full flex items-center py-5 fixed top-0 z-20 ${a?"bg-primary":"bg-transparent"}
    `,children:h("div",{className:"w-full flex justify-between items-center max-w-7xl mx-auto",children:[h(z,{to:"/",className:"flex items-center gap-2",onClick:()=>{t(""),window.scrollTo(0,0)},children:[o("img",{src:wn,alt:"logo",className:"w-9 h-9 object-contain"}),h("p",{className:"text-white text-[18px] font-bold cursor-pointer flex",children:["Samrat  ",o("span",{className:"hidden sm:block",children:"| Portfolio"})]})]}),o("ul",{className:"list-none hidden sm:flex flex-row gap-10",children:xe.map(s=>s.id==="blog"?o("li",{className:`${e===s.title?"text-white":"text-secondary"} hover:text-white text-[18px] font-medium cursor-pointer`,onClick:()=>t(s.title),children:o(z,{to:"/blog/",children:s.title})},s.id):o("li",{className:`${e===s.title?"text-white":"text-secondary"} hover:text-white text-[18px] font-medium cursor-pointer`,onClick:()=>t(s.title),children:o(z,{to:`/#${s.id}`,children:s.title})},s.id))}),h("div",{className:"sm:hidden flex flex-1 justify-end items-center",children:[o("img",{src:n?vn:bn,alt:"menu",className:"w-[28px] h-[28px] object-contain cursor-pointer",onClick:()=>r(!n)}),o("div",{className:`${n?"flex":"hidden"} p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`,children:o("ul",{className:"list-none flex justify-end items-start flex-col gap-4",children:xe.map(s=>s.id==="blog"?o("li",{className:`${e===s.title?"text-white":"text-secondary"} font-poppins font-medium cursor-pointer text-[16px]`,onClick:()=>{r(!n),t(s.title)},children:o(z,{to:"/blog/",children:s.title})},s.id):o("li",{className:`${e===s.title?"text-white":"text-secondary"} font-poppins font-medium cursor-pointer text-[16px]`,onClick:()=>{r(!n),t(s.title)},children:o(z,{to:`/#${s.id}`,children:s.title})},s.id))})})]})]})})};function He(e){const t=e.match(/^---([\s\S]*?)---/);if(!t)return{};const n=t[1],r={},a=n.trim().split(`
`);for(const i of a){const s=i.match(/(.+?):\s*(.+)/);if(s){let[,l,c]=s;if(l=l.trim(),c=c.trim(),c.startsWith('"')&&c.endsWith('"')&&(c=c.slice(1,-1)),c.startsWith("[")&&c.endsWith("]"))try{c=JSON.parse(c)}catch{}r[l]=c}}return r}function cr(e,t=150){let r=e.replace(/^---[\s\S]*?---/,"").replace(/#+\s+/g,"").replace(/\*\*(.+?)\*\*/g,"$1").replace(/\*(.+?)\*/g,"$1").replace(/!\[(.*?)\]\(.*?\)/g,"").replace(/\[(.*?)\]\(.*?\)/g,"$1").replace(/```[\s\S]*?```/g,"").replace(/`([^`]+)`/g,"$1").replace(/-{3,}/g,"").replace(/\n/g," ").trim();return r.length>t&&(r=r.substring(0,t)+"..."),r}function Fe(e){return e.split("/").pop().replace(/\.[^.]+$/,"")}const Wi=({children:e,title:t})=>{const[r,a]=y.useState([]),[i,s]=y.useState([]),[l,c]=y.useState(1),d=u=>{if(u<1||u>Math.ceil(r.length/5))return;c(u);const m=(u-1)*5;s(r.slice(m,m+5))};return y.useEffect(()=>{async function u(){try{const p=Object.entries(Object.assign({"../../blog/posts/cloudflare-workers-full-stack.mdx":Ne,"../../blog/posts/cloudflare-zero-trust-homelab.mdx":_e,"../../blog/posts/enterprise-ai-roi.mdx":Re,"../../blog/posts/github-pages-cloudflare-subdomain.mdx":De,"../../blog/posts/how-i-finally-organized-my-notes.mdx":je,"../../blog/posts/lighthouse-ai-workflow.mdx":Le,"../../blog/posts/spa-routing-hostinger.mdx":ze,"../../blog/posts/tmux-config.mdx":Be})).map(([f,g])=>{const v=Fe(f),b=He(g);return{slug:v,title:b.title||"Untitled Post",date:b.date||"No date",tags:b.tags||[]}});p.sort((f,g)=>new Date(g.date)-new Date(f.date)),a(p),s(p.slice(0,5))}catch(m){console.error("Error loading blog posts for sidebar:",m),a([]),s([])}}u()},[]),h("div",{className:"relative z-0 bg-primary",children:[o(lr,{}),o("div",{className:`${C.padding} max-w-7xl mx-auto relative z-0 mt-20`,children:h("div",{className:"flex flex-col md:flex-row gap-10",children:[o("div",{className:"md:w-1/4",children:h("div",{className:"sticky top-24 p-5 rounded-xl bg-tertiary bg-opacity-70 backdrop-blur-lg",children:[o("h3",{className:"text-white font-bold text-xl mb-4",children:"Recent Posts"}),h("ul",{className:"divide-y divide-gray-700/30",children:[i.map((u,m)=>h("li",{className:`py-4 ${m===0?"pt-0":""}`,children:[o(z,{to:`/blog/${u.slug}/`,className:"block text-secondary hover:text-white transition-colors duration-300 font-medium",children:u.title}),o("div",{className:"text-xs text-gray-400 mt-1",children:u.date}),o("div",{className:"flex flex-wrap gap-1 mt-2",children:u.tags.map(p=>h("span",{className:"text-xs bg-[#915eff]/20 text-[#dfd9ff] px-2 py-1 rounded-full",children:["#",p]},p))})]},u.slug))," "]}),r.length>5&&o("div",{className:"mt-4 flex justify-center pt-2 border-t border-gray-700/30 text-xs",children:h("div",{className:"inline-flex items-center gap-2",children:[o("button",{onClick:()=>d(l-1),disabled:l===1,className:`${l===1?"text-gray-500 cursor-not-allowed":"text-secondary hover:text-white cursor-pointer"}`,children:"←"}),h("span",{className:"text-secondary mx-1",children:[l,"/",Math.ceil(r.length/5)]}),o("button",{onClick:()=>d(l+1),disabled:l>=Math.ceil(r.length/5),className:`${l>=Math.ceil(r.length/5)?"text-gray-500 cursor-not-allowed":"text-secondary hover:text-white cursor-pointer"}`,children:"→"})]})})]})}),h("div",{className:"md:w-3/4 overflow-hidden",children:[t&&o("h1",{className:`${C.sectionHeadText} mb-6`,children:t}),o("div",{className:"prose prose-invert prose-lg prose-headings:text-white prose-headings:font-bold prose-h1:text-4xl prose-h2:text-3xl prose-h2:mt-8 prose-h3:text-2xl prose-p:text-gray-300 prose-a:text-[#915eff] prose-strong:text-white prose-code:bg-tertiary prose-code:text-white prose-code:p-1 prose-code:rounded-md prose-pre:bg-transparent prose-pre:p-0 prose-pre:overflow-x-auto prose-li:text-gray-300 max-w-none [&_code::before]:content-none [&_code::after]:content-none",children:e})]})]})})]})},Ui=({post:e})=>h(z,{to:`/blog/${e.slug}/`,className:"block bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full transition-all duration-300 hover:shadow-lg hover:shadow-purple-900/20 group",children:[h("div",{className:"mt-5",children:[o("h3",{className:"text-white font-bold text-[24px] group-hover:text-[#915eff] transition-colors duration-300",children:e.title}),o("p",{className:"mt-2 text-secondary text-[14px]",children:e.date})]}),o("div",{className:"mt-4 text-secondary text-[14px] leading-[24px]",children:e.excerpt}),o("div",{className:"flex flex-wrap gap-2 mt-4",children:e.tags.map(t=>h("span",{className:"text-xs bg-[#915eff]/20 text-[#dfd9ff] px-2 py-1 rounded-full",children:["#",t]},t))})]}),ve="https://www.samratjha.com",Gi=({onSearch:e})=>{const[t,n]=y.useState("");return o("div",{className:"mb-8",children:h("div",{className:"relative overflow-hidden",children:[o("input",{type:"text",value:t,onChange:i=>{const s=i.target.value;n(s),e(s)},placeholder:"Search posts...",className:"w-full p-3 pr-10 bg-tertiary bg-opacity-70 backdrop-blur-lg rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#915eff] border border-transparent"}),t&&o("button",{onClick:()=>{n(""),e("")},className:"absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-white",children:"✕"})]})})},en=()=>{const[e,t]=y.useState([]),[n,r]=y.useState([]),[a,i]=y.useState(1),s=6,[l,c]=y.useState([]);y.useEffect(()=>{async function p(){try{const g=Object.entries(Object.assign({"../../blog/posts/cloudflare-workers-full-stack.mdx":Ne,"../../blog/posts/cloudflare-zero-trust-homelab.mdx":_e,"../../blog/posts/enterprise-ai-roi.mdx":Re,"../../blog/posts/github-pages-cloudflare-subdomain.mdx":De,"../../blog/posts/how-i-finally-organized-my-notes.mdx":je,"../../blog/posts/lighthouse-ai-workflow.mdx":Le,"../../blog/posts/spa-routing-hostinger.mdx":ze,"../../blog/posts/tmux-config.mdx":Be})).map(([v,b])=>{const w=Fe(v),A=He(b);return{slug:w,title:A.title||"Untitled Post",date:A.date||"No date",excerpt:A.excerpt||cr(b),tags:A.tags||[],buttonText:"Read More"}});g.sort((v,b)=>new Date(b.date)-new Date(v.date)),t(g),r(g),c(g.slice(0,s))}catch(f){console.error("Error loading blog posts:",f)}}p()},[]);const d=p=>{if(p<1||p>Math.ceil(n.length/s))return;i(p);const f=(p-1)*s;c(n.slice(f,f+s))},u=p=>{if(!p.trim()){r(e);return}const f=e.filter(g=>{const v=p.toLowerCase();return g.title?.toLowerCase().includes(v)||g.excerpt?.toLowerCase().includes(v)||g.tags?.some(b=>b.toLowerCase().includes(v))});r(f),i(1),c(f.slice(0,s))},m={"@context":"https://schema.org","@type":"CollectionPage",name:"Blog | Samrat Jha",description:"Technical blog posts on AI, infrastructure, web development, and software engineering by Samrat Jha.",url:`${ve}/blog/`,author:{"@type":"Person",name:"Samrat Jha",url:`${ve}/`}};return h(te,{children:[h(nt,{children:[o("title",{children:"Blog | Samrat Jha"}),o("meta",{name:"description",content:"Technical blog posts on AI, infrastructure, web development, and software engineering by Samrat Jha."}),o("link",{rel:"canonical",href:`${ve}/blog/`}),o("meta",{property:"og:type",content:"website"}),o("meta",{property:"og:url",content:`${ve}/blog/`}),o("meta",{property:"og:title",content:"Blog | Samrat Jha"}),o("meta",{property:"og:description",content:"Technical blog posts on AI, infrastructure, web development, and software engineering."}),o("meta",{property:"og:site_name",content:"Samrat Jha"}),o("meta",{name:"twitter:card",content:"summary"}),o("meta",{name:"twitter:title",content:"Blog | Samrat Jha"}),o("meta",{name:"twitter:description",content:"Technical blog posts on AI, infrastructure, web development, and software engineering."}),o("script",{type:"application/ld+json",children:JSON.stringify(m)})]}),o(Wi,{title:"Blog",children:h("div",{className:"mt-12",children:[o(Gi,{onSearch:u}),h("div",{className:"mt-10 flex flex-wrap gap-7",children:[n.length>0?l.map((p,f)=>o(Ui,{post:p},p.slug)):o("p",{className:"text-secondary",children:"No posts found matching your search criteria."}),n.length>s&&o("div",{className:"w-full mt-8 flex justify-center items-center text-sm",children:h("div",{className:"inline-flex items-center gap-3 text-secondary",children:[o("button",{onClick:()=>d(a-1),disabled:a===1,className:`${a===1?"opacity-50 cursor-not-allowed":"hover:text-white cursor-pointer"}`,children:"←"}),h("span",{className:"text-secondary",children:["Page ",a," of"," ",Math.ceil(n.length/s)]}),o("button",{onClick:()=>d(a+1),disabled:a>=Math.ceil(n.length/s),className:`${a>=Math.ceil(n.length/s)?"opacity-50 cursor-not-allowed":"hover:text-white cursor-pointer"}`,children:"→"})]})})]})]})})]})},qe=({children:e,title:t})=>{const[r,a]=y.useState([]),[i,s]=y.useState([]),[l,c]=y.useState(1),[d,u]=y.useState(!1),m=p=>{if(p<1||p>Math.ceil(r.length/5))return;c(p);const f=(p-1)*5;s(r.slice(f,f+5))};return y.useEffect(()=>{async function p(){try{const g=Object.entries(Object.assign({"../../blog/posts/cloudflare-workers-full-stack.mdx":Ne,"../../blog/posts/cloudflare-zero-trust-homelab.mdx":_e,"../../blog/posts/enterprise-ai-roi.mdx":Re,"../../blog/posts/github-pages-cloudflare-subdomain.mdx":De,"../../blog/posts/how-i-finally-organized-my-notes.mdx":je,"../../blog/posts/lighthouse-ai-workflow.mdx":Le,"../../blog/posts/spa-routing-hostinger.mdx":ze,"../../blog/posts/tmux-config.mdx":Be})).map(([v,b])=>{const w=Fe(v),A=He(b);return{slug:w,title:A.title||"Untitled Post",date:A.date||"No date",tags:A.tags||[]}});g.sort((v,b)=>new Date(b.date)-new Date(v.date)),a(g),s(g.slice(0,5))}catch(f){console.error("Error loading blog posts for sidebar:",f),a([]),s([])}}p()},[]),h("div",{className:"relative z-0 bg-primary",children:[o(lr,{}),h("div",{className:`${C.padding} max-w-7xl mx-auto relative z-0 mt-20`,children:[h("div",{className:"mb-16",children:[t&&o("h1",{className:`${C.sectionHeadText} mb-6`,children:t}),o("div",{className:"prose prose-invert prose-lg prose-headings:text-white prose-headings:font-bold prose-h1:text-4xl prose-h2:text-3xl prose-h2:mt-8 prose-h3:text-2xl prose-p:text-gray-300 prose-a:text-[#915eff] prose-strong:text-white prose-code:bg-tertiary prose-code:text-white prose-code:p-1 prose-code:rounded-md prose-pre:bg-transparent prose-pre:p-0 prose-pre:overflow-x-auto prose-li:text-gray-300 max-w-none [&_code::before]:content-none [&_code::after]:content-none",children:e})]}),h("div",{className:"mt-12 pt-8 border-t border-gray-800",children:[h("button",{onClick:()=>u(!d),className:"flex items-center text-white font-medium mb-4 hover:text-[#915eff] transition-colors duration-300",children:[o("span",{className:"mr-2",children:d?"▼":"►"}),o("h3",{className:"font-bold text-xl",children:"Recent Posts"})]}),d&&h("div",{className:"p-5 rounded-xl bg-tertiary bg-opacity-70 backdrop-blur-lg",children:[o("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:i.map((p,f)=>h("div",{className:"border-b border-gray-700/30 pb-4 last:border-b-0",children:[o(z,{to:`/blog/${p.slug}/`,className:"block text-secondary hover:text-white transition-colors duration-300 font-medium",children:p.title}),o("div",{className:"text-xs text-gray-400 mt-1",children:p.date}),o("div",{className:"flex flex-wrap gap-1 mt-2",children:p.tags.slice(0,3).map(g=>h("span",{className:"text-xs bg-[#915eff]/20 text-[#dfd9ff] px-2 py-1 rounded-full",children:["#",g]},g))})]},p.slug))}),r.length>5&&o("div",{className:"mt-4 flex justify-center pt-2 border-t border-gray-700/30 text-xs",children:h("div",{className:"inline-flex items-center gap-2",children:[o("button",{onClick:()=>m(l-1),disabled:l===1,className:`${l===1?"text-gray-500 cursor-not-allowed":"text-secondary hover:text-white cursor-pointer"}`,children:"←"}),h("span",{className:"text-secondary mx-1",children:[l,"/",Math.ceil(r.length/5)]}),o("button",{onClick:()=>m(l+1),disabled:l>=Math.ceil(r.length/5),className:`${l>=Math.ceil(r.length/5)?"text-gray-500 cursor-not-allowed":"text-secondary hover:text-white cursor-pointer"}`,children:"→"})]})})]})]})]})]})};const le="https://www.samratjha.com",Y={name:"Samrat Jha",url:"https://www.samratjha.com/",jobTitle:"Senior AI Engineer",employer:"NVIDIA"},tn=()=>{const{slug:e}=Sr(),[t,n]=y.useState(null),[r,a]=y.useState(!0),[i,s]=y.useState(!1);y.useEffect(()=>{async function g(){try{a(!0);const v=Object.assign({"../../blog/posts/cloudflare-workers-full-stack.mdx":()=>P(()=>import("./cloudflare-workers-full-stack-47a7f3ec.js"),["assets/cloudflare-workers-full-stack-47a7f3ec.js","assets/three-5874ebf6.js"]),"../../blog/posts/cloudflare-zero-trust-homelab.mdx":()=>P(()=>import("./cloudflare-zero-trust-homelab-b4b58cb1.js"),["assets/cloudflare-zero-trust-homelab-b4b58cb1.js","assets/three-5874ebf6.js"]),"../../blog/posts/enterprise-ai-roi.mdx":()=>P(()=>import("./enterprise-ai-roi-945c1e47.js"),["assets/enterprise-ai-roi-945c1e47.js","assets/three-5874ebf6.js"]),"../../blog/posts/github-pages-cloudflare-subdomain.mdx":()=>P(()=>import("./github-pages-cloudflare-subdomain-38774022.js"),["assets/github-pages-cloudflare-subdomain-38774022.js","assets/three-5874ebf6.js"]),"../../blog/posts/how-i-finally-organized-my-notes.mdx":()=>P(()=>import("./how-i-finally-organized-my-notes-519d6eb3.js"),["assets/how-i-finally-organized-my-notes-519d6eb3.js","assets/three-5874ebf6.js"]),"../../blog/posts/lighthouse-ai-workflow.mdx":()=>P(()=>import("./lighthouse-ai-workflow-e77f9270.js"),["assets/lighthouse-ai-workflow-e77f9270.js","assets/three-5874ebf6.js"]),"../../blog/posts/spa-routing-hostinger.mdx":()=>P(()=>import("./spa-routing-hostinger-62f088db.js"),["assets/spa-routing-hostinger-62f088db.js","assets/three-5874ebf6.js"]),"../../blog/posts/tmux-config.mdx":()=>P(()=>import("./tmux-config-f630dee9.js"),["assets/tmux-config-f630dee9.js","assets/three-5874ebf6.js"])}),w=Object.keys(v).find(hr=>Fe(hr)===e);if(!w){s(!0),a(!1);return}const D=Object.assign({"../../blog/posts/cloudflare-workers-full-stack.mdx":Ne,"../../blog/posts/cloudflare-zero-trust-homelab.mdx":_e,"../../blog/posts/enterprise-ai-roi.mdx":Re,"../../blog/posts/github-pages-cloudflare-subdomain.mdx":De,"../../blog/posts/how-i-finally-organized-my-notes.mdx":je,"../../blog/posts/lighthouse-ai-workflow.mdx":Le,"../../blog/posts/spa-routing-hostinger.mdx":ze,"../../blog/posts/tmux-config.mdx":Be})[w],fe=He(D),dr=fe.description||cr(D,160),ur=(await v[w]()).default;n({title:fe.title||"Untitled Post",date:fe.date||"No date",description:dr,tags:fe.tags||[],component:ur,slug:e}),a(!1)}catch(v){console.error("Error loading blog post:",v),s(!0),a(!1)}}g()},[e]);const l=g=>!g||g==="No date"?null:new Date(g).toISOString(),c=()=>{if(!t)return null;const g=l(t.date);return{"@context":"https://schema.org","@type":"BlogPosting",headline:t.title,description:t.description,datePublished:g,dateModified:g,author:{"@type":"Person",name:Y.name,url:Y.url,jobTitle:Y.jobTitle},publisher:{"@type":"Person",name:Y.name,url:Y.url},mainEntityOfPage:{"@type":"WebPage","@id":`${le}/blog/${t.slug}/`},keywords:t.tags.join(", ")}},d=()=>t?{"@context":"https://schema.org","@type":"BreadcrumbList",itemListElement:[{"@type":"ListItem",position:1,name:"Home",item:`${le}/`},{"@type":"ListItem",position:2,name:"Blog",item:`${le}/blog/`},{"@type":"ListItem",position:3,name:t.title,item:`${le}/blog/${t.slug}/`}]}:null;if(r)return o(qe,{children:o("div",{className:"text-center py-20",children:o("h1",{className:"text-4xl text-white font-bold mb-4",children:"Loading..."})})});if(i||!t)return h(te,{children:[h(nt,{children:[o("title",{children:"Post Not Found | Samrat Jha"}),o("meta",{name:"robots",content:"noindex"})]}),o(qe,{children:h("div",{className:"text-center py-20",children:[o("h1",{className:"text-4xl text-white font-bold mb-4",children:"Post Not Found"}),o("p",{className:"text-secondary",children:"The blog post you're looking for doesn't exist."})]})})]});const u=t.component,m=`${le}/blog/${t.slug}/`,p=c(),f=d();return h(te,{children:[h(nt,{children:[h("title",{children:[t.title," | Samrat Jha"]}),o("meta",{name:"title",content:`${t.title} | Samrat Jha`}),o("meta",{name:"description",content:t.description}),o("meta",{name:"author",content:Y.name}),o("meta",{name:"keywords",content:t.tags.join(", ")}),o("link",{rel:"canonical",href:m}),o("meta",{property:"og:type",content:"article"}),o("meta",{property:"og:url",content:m}),o("meta",{property:"og:title",content:t.title}),o("meta",{property:"og:description",content:t.description}),o("meta",{property:"og:site_name",content:"Samrat Jha"}),o("meta",{property:"article:published_time",content:l(t.date)}),o("meta",{property:"article:author",content:Y.url}),t.tags.map(g=>o("meta",{property:"article:tag",content:g},g)),o("meta",{name:"twitter:card",content:"summary"}),o("meta",{name:"twitter:url",content:m}),o("meta",{name:"twitter:title",content:t.title}),o("meta",{name:"twitter:description",content:t.description}),o("script",{type:"application/ld+json",children:JSON.stringify(p)}),o("script",{type:"application/ld+json",children:JSON.stringify(f)})]}),o(qe,{title:t.title,children:h("div",{children:[h("div",{className:"mb-6",children:[o("p",{className:"text-secondary",children:t.date}),o("div",{className:"flex flex-wrap gap-2 mt-2",children:t.tags.map(g=>h("span",{className:"text-xs bg-[#915eff]/20 text-[#dfd9ff] px-2 py-1 rounded-full",children:["#",g]},g))})]}),o("article",{className:"prose prose-invert prose-lg max-w-none blog-post-content",children:o(u,{})})]})})]})},Vi=()=>{const{hash:e}=ln();return y.useEffect(()=>{if(e){const t=document.querySelector(e);t&&t.scrollIntoView({behavior:"smooth"})}},[e]),h("div",{className:"relative z-0 bg-primary",children:[h("div",{className:"bg-hero-pattern bg-cover bg-no-repeat bg-center",children:[o(Za,{}),o(Aa,{})]}),o(zi,{}),o(Po,{}),o(ro,{}),o(Di,{}),o("div",{className:"relative z-0",children:o(Fi,{})}),o(ma,{})]})},Yi=()=>h(Ir,{children:[o(re,{path:"/",element:o(Vi,{})}),o(re,{path:"/blog",element:o(en,{})}),o(re,{path:"/blog/",element:o(en,{})}),o(re,{path:"/blog/:slug",element:o(tn,{})}),o(re,{path:"/blog/:slug/",element:o(tn,{})})]});const Xe=document.getElementById("root"),nn=o(W.StrictMode,{children:o(fn,{children:o(kr,{children:o(Yi,{})})})});Xe.hasChildNodes()?Er(Xe,nn):Tr(Xe).render(nn);export{bs as p,ke as u};
