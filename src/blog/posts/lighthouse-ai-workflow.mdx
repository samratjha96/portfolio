...
Or run multiple URLs and compare. The slash command is just a prompt template—customize it for whatever workflow you need.

---

The command file: [.claude/commands/analyze-website-performance.md](https://github.com/samratjha96/portfolio/blob/main/.claude/commands/analyze-website-performance.md)
