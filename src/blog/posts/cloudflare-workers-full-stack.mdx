...
I just deployed [Space Selfie](https://space-selfie.zasamrat.workers.dev) to Cloudflare Workers—a single deployment serving both the API and frontend, running on the edge globally, for $0/month. Figured I'd document what actually went into it.
