...
It's personal. So `30-39`. It's about living arrangements. So `33 Living`. Maybe a file like `rental_agreement_2026.pdf`.

You could go a level deeper: `33 Living/Apartment/Rental Agreements/2026/<file>`. But you get the idea. I can organize within the drawers whenever I want. The drawers just help me put things in a state where they _can_ be organized.

Another one: you find a cool recipe online and want to save it. Personal, so `30-39`. Food, so `36 Food`. Done. Maybe later you organize `36 Food` into subfolders for cuisines or meal types. Maybe you never do. Either way, you know where recipes live.
