...
In plain English, this configuration tells the Apache server:

1. "Hey, enable URL rewriting for this directory"
2. "If someone requests a URL that isn't a real file or folder on the server..."
3. "...serve them index.html instead, and let the client-side router handle it"
