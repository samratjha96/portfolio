  ...
  return (
    <>
      ...
      >
        ...
        intelligence. I bring{" "}
        <a
          href="#work"
          className="underline text-[#915eff] hover:text-blue-800"
        >
          7+ years of experience
        </a>{" "}
        architecting large-scale distributed systems, including 4 years at AWS
        building edge computing infrastructure, Generative AI applications, and
        event pipelines handling millions of requests. I've shipped systems at
        scale, led cross-org initiatives, and developed everything from
