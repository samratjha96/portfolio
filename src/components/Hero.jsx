  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#915eff]'>Samrat Jha</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Full stack software engineer dabbling <br className="sm:block hidden" />in 3D visuals and web applications
          </p>
        </div>
      </div>
      <ComputersCanvas />
